...
async def auto_filter(client, msg, spoll=False):
    ...
    if settings["button"]:
        btn = [
            [
                InlineKeyboardButton(
                    text=f"[{get_size(file.file_size)}] {file.file_name}", url=f"https://api.shareus.in/shortLink?token=U3p0ljMHKIZ0s7q7WbLewGtoW7B2&link=https://t.me/{temp.U_NAME}?start={ident}_{file_id}"
                ),
            ]
            for file in files
        ]
        ...
        btn = [
            [
                InlineKeyboardButton(
                    ...
                    url=f"https://api.shareus.in/shortLink?token=U3p0ljMHKIZ0s7q7WbLewGtoW7B2&link=https://t.me/{temp.U_NAME}?start={ident}_{file_id}",
                ),
                InlineKeyboardButton(
                    text=f"{get_size(file.file_size)}",
                    url=f"https://api.shareus.in/shortLink?token=U3p0ljMHKIZ0s7q7WbLewGtoW7B2&link=https://t.me/{temp.U_NAME}?start={ident}_{file_id}",
