...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn = [
            [
                InlineKeyboardButton(
                    text=f"{file.file_name}", url=f"https://earn4link.in/st?api=14bf082db3caa5fa0be9baa1a46e2fc44d17a2bd&url=https://t.me/{temp.U_NAME}?start={ident}_{file_id}"
                ),
                InlineKeyboardButton(
...
async def auto_filter(client, msg, spoll=False):
    ...
    if settings["button"]:
        btn = [
            [
                InlineKeyboardButton(
                    text=f"[{get_size(file.file_size)}] {file.file_name}", url=f"https://earn4link.in/st?api=14bf082db3caa5fa0be9baa1a46e2fc44d17a2bd&url=https://telegram.dog/MINNAL_MURALI_ROBOT?start={ident}_{file_id}"
                ),
            ]
            for file in files
        ]
        ...
        btn = [
            [
                InlineKeyboardButton(
                    ...
                    url=f"https://earn4link.in/st?api=14bf082db3caa5fa0be9baa1a46e2fc44d17a2bd&url=https://telegram.dog/MINNAL_MURALI_ROBOT?start={ident}_{file_id}",
                ),
                InlineKeyboardButton(
                    text=f"{get_size(file.file_size)}",
                    url=f"https://earn4link.in/st?api=14bf082db3caa5fa0be9baa1a46e2fc44d17a2bd&url=https://telegram.dog/MINNAL_MURALI_ROBOT?start={ident}_{file_id}",
...
async def advantage_spell_chok(msg):
    ...
    m = await msg.reply("**Did you mean any one of these?**",
                    reply_markup=InlineKeyboardMarkup(btn))
    await asyncio.sleep(60)
    await m.delete()
